  ...
  return (
    <>
      <PageHeader
        ...
        intro="Please fill out the Quick Inquiry or Detailed Trip Intake form, and we will personally respond to set up your complimentary consultation call if you are a new client."
      />

      <Section className="!pt-0">
        <div className="mx-auto mb-14 flex w-fit border border-walnut">
          <button
            type="button"
            ...
            <form onSubmit={onSubmitDetailed} className="space-y-14">
              <div className="space-y-8">
                ...
                <div className="grid gap-10 sm:grid-cols-2">
                  <div>
                    ...
                    <input id="d-email" name="email" type="email" required className={fieldClass} />
                  </div>
                  <div>
              ...
              <div className="space-y-8">
                ...
                <p className="border-l-2 border-oxblood/60 bg-secondary/60 p-5 text-xs font-light italic leading-relaxed text-muted-foreground">
                  ...
                  start at $525 per week of travel. For full itinerary planning including concierge
                  services (dinner recommendations &amp; reservations, spa appointments, golf tee
                  times, etc.), my planning fees start at $1,050 per week of travel.
                </p>
              ...
              <div className="space-y-8">
                ...
                <div>
                  <label className={labelClass} htmlFor="personalStyle">
                    Help me understand your personal style. What are some of your favorite hotels or
                    experiences?
                  </label>
                  <textarea
                    id="personalStyle"
              ...
              <div className="space-y-6 border-t border-border pt-10">
                ...
                <label className="flex items-start gap-3 text-xs font-light leading-relaxed text-muted-foreground">
                  ...
                  <span>
                    Please be aware that there may be a planning fee associated with the creation of
                    your customized itinerary. During our complimentary intake call, we'll discuss
                    your travel details &amp; goals before providing you with a detailed
                ...
                <label className="flex items-start gap-3 text-xs font-light leading-relaxed text-muted-foreground">
                  ...
                  <span>
                    ...
                    have confidential, contracted rates from local vendors, and creates a seamless,
                    holistic approach to your travel plans.{" "}
                ...
                <label className="flex items-start gap-3 text-xs font-light leading-relaxed text-muted-foreground">
                  ...
                  <span>
                    While planning your trip, we will primarily be in contact via email or scheduled
                    phone calls, to ensure no important information is overlooked — we strongly
                    discourage questions via text message. Before your departure, we'll provide the
                    best local contact information for prompt assistance after business hours;
      ...
      <Section className="!pt-0">
        <div className="mx-auto max-w-2xl border-t border-border pt-16">
          <p className="eyebrow text-center">The ARP Process</p>
