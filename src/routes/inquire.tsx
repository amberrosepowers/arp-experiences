                ...
                <form onSubmit={onSubmitDetailed} className="space-y-14">
                  ...
                  <div className="space-y-6 border-t border-border pt-10">
                    ...
                    <label className="flex items-start gap-3 text-xs font-light leading-relaxed text-muted-foreground">
                      ...
                      <span>
                        Please be aware that there may be a planning fee associated with the
                        creation of your customized itinerary. During our complimentary intake call,
                        we'll discuss your travel details &amp; goals before providing you with a
                        detailed understanding of any associated fees based upon the unique aspects
                        and complexities of your trip request.{" "}
                    ...
                    <label className="flex items-start gap-3 text-xs font-light leading-relaxed text-muted-foreground">
                      ...
                      <span>
                        ...
                        breaking down individual components. This protects our valued partners who
                        may have confidential, contracted rates from local vendors, and creates a
                        seamless, holistic approach to your travel plans.{" "}
                        <strong className="text-foreground">
                          I understand my proposal will come as one packaged rate and itemized
                    ...
                    <label className="flex items-start gap-3 text-xs font-light leading-relaxed text-muted-foreground">
                      ...
                      <span>
                        ...
                        business hours; unscheduled calls and texts remain available for any
