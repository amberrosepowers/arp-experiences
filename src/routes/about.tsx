...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      ...
      { property: "og:image", content: "https://www.arpexperiences.com/photos/founder-amber.jpg" },
      { property: "og:image:width", content: "1400" },
      { property: "og:image:height", content: "1866" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:image", content: "https://www.arpexperiences.com/photos/founder-amber.jpg" },
    ],
  }),
  component: About,
});
